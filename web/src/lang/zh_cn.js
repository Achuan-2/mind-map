export default {
  ...
  noteToMindmap: {
    title: '笔记转导图',
    blockId: '块ID',
    blockIdPlaceholder: '请输入思源笔记块ID',
    setCurrentDoc: '当前文档',
    setCurrentDocTip: '设置为导图块所在文档',
    blockType: '块类型',
    document: '文档',
    block: '块',
    importType: '导入类型',
    ...
    importContent: '文档内容',
    autoNumber: '自动编号',
    autoNumberDesc: '为节点添加层级编号（1, 1.1, 1.1.1）',
    maxLevel: '导入层级',
    maxLevelDesc: '限制导入的层级深度，0表示不限制',
    autoRefresh: '自动获取块内容',
    autoRefreshDesc: '打开导图时自动同步绑定块的内容',
    queryBlock: '查询块',
    import: '导入',
    querySuccess: '查询成功',
    blockNotFound: '未找到该块',
    queryFailed: '查询失败',
    pleaseInputBlockId: '请输入笔记本ID或块ID',
    pleaseQueryFirst: '请先查询块信息',
    importSuccess: '导入成功',
    importFailed: '导入失败',
    noCurrentDoc: '无法获取当前文档',
    importDocTree: '子文档树',
    startPath: '起始路径',
    startPathDesc: '从该路径开始导入，默认使用文档所在路径或 /',
    notebook: '笔记本',
    cannotGetNotebook: '无法获取文档所属笔记本ID',
    cannotGetDocPath: '无法获取文档所在路径，请手动输入起始路径',
    noBlockSetting: '未设置绑定块',
    refreshSuccess: '刷新成功',
    refreshFailed: '刷新失败'
  },
  edit: {

export default {
  ...
  toolbar: {
    ...
    noteToMindmap: 'Note to Mindmap',
    refreshFromBlock: 'Refresh',
    refreshFromBlockTip: 'Refresh mindmap from bound block'
  },
  noteToMindmap: {
    title: 'Note to Mindmap',
    blockId: 'Block ID',
    blockIdPlaceholder: 'Please enter SiYuan block ID',
    setCurrentDoc: 'Current Doc',
    setCurrentDocTip: 'Set to the document where mindmap block located',
    blockType: 'Block Type',
    document: 'Document',
    block: 'Block',
    importType: 'Import Type',
    importOutline: 'Outline Headings',
    importContent: 'Document Content',
    autoNumber: 'Auto Number',
    autoNumberDesc: 'Add hierarchical numbering (1, 1.1, 1.1.1)',
    maxLevel: 'Import Level',
    maxLevelDesc: 'Limit import depth, 0 means no limit',
    autoRefresh: 'Auto Fetch Block Content',
    autoRefreshDesc: 'Automatically sync bound block content when opening mindmap',
    queryBlock: 'Query Block',
    import: 'Import',
    querySuccess: 'Query success',
    blockNotFound: 'Block not found',
    queryFailed: 'Query failed',
    pleaseInputBlockId: 'Please enter block ID',
    pleaseQueryFirst: 'Please query block info first',
    importSuccess: 'Import success',
